        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex justify-between items-center p-2 rounded-t border-b">
                <div class="text-base font-bold mt-3 sm:mt-0 sm:ml-4 sm:text-left blue-color">
                    <?php echo e(__('Approve Mission ')); ?>:<?php echo e($missionOrder->order_number); ?>:<?php echo e($missionOrder->purpose); ?>
            ...
            <div class="p-4 overflow-y-auto" style="max-height: 700px">
                <form method="POST"
                    action="<?php echo e(route('mission_approves.approve', $missionOrder->id)); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH /srv/mission-order-app/resources/views/partials/modals/_approve-mission.blade.php ENDPATH**/ ?>