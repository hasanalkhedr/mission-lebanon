...
<?php echo $__env->make('partials.searches._search-departments', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white hover:bg-gray-50">
                        <td class="border-b py-4 px-6 font-bold text-gray-900 whitespace-nowrap cursor-pointer"
                            onclick="window.location.href = '<?php echo e(url(route('departments.show', ['department' => $department->id]))); ?>'">
                            <div class="cursor-pointer">
                                <?php echo e($department->name); ?>

                            </div>
                        </td>
                        <?php if($department->manager == null): ?>
                        ...
                        <?php else: ?>
                            <td class="py-4 px-6 border-b cursor-pointer"
                                onclick="window.location.href = '<?php echo e(url(route('employees.show', ['employee' => $department->manager_id]))); ?>'">
                                <div class="cursor-pointer">
                                    <?php echo e($department->manager->first_name); ?> <?php echo e($department->manager->last_name); ?>
            ...
            <?php else: ?>
                <tr class="border-gray-300">
                    <td colspan="4" class="px-4 py-8 border-t border-gray-300 text-lg">
                        <p class="text-center"><?php echo e(__('No Departments Found')); ?></p>
                    </td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
<?php echo $__env->make('partials.modals._create-department', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/mission-order-app/resources/views/departments/index.blade.php ENDPATH**/ ?>