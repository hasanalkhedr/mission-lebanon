...
<?php $__env->startSection('title', __('Tournees')); ?>
<nav class="flex justify-between items-center p-2 text-black font-bold">
    <div class="text-lg blue-color">
        <?php echo e(__('Tournees')); ?>

    </div>
    
    <?php if(auth()->user()->employee->allow_order): ?>
        <div>
            <a href="<?php echo e(route('tournees.create')); ?>" class="hover:bg-blue-700 text-white py-2 px-4 rounded-full blue-bg">
                <?php echo e(__('Ordre de Tournee')); ?>
...
<?php echo $__env->make('partials.searches._search-tournees', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <?php $__currentLoopData = $tournees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white hover:bg-gray-50">
                        <td class="border-b py-4 px-6 font-bold text-gray-900 whitespace-nowrap cursor-pointer"
                            onclick="window.location.href = '<?php echo e(url(route('tournees.show', $tournee->id))); ?>'">
                        ...
                        <td class="py-4 px-6 border-b cursor-pointer">
                            <div class="cursor-pointer">
                                <?php echo e(__($tournee->status)); ?>

                            </div>
                        </td>
                        <?php switch($tournee->status):
                            case ('draft'): ?>
                                <?php if(auth()->user()->employee->id === $tournee->employee_id): ?>
                                    <td class="text-center px-0 py-1 border-b">
                                        <a href="<?php echo e(route('tournees.edit', $tournee->id)); ?>"
                            ...
                            <?php case ('sup_approve'): ?>
                                <?php if(auth()->user()->employee->role === 'supervisor' &&
                                    ...
                                    <td class="text-center px-0 py-1 border-b">
                                        <a href="<?php echo e(route('tournees.report', $tournee->id)); ?>"
                            ...
                            <?php case ('approved'): ?>
                                <?php if($tournee->employee->id == auth()->user()->employee->id): ?>
                                    <td class="text-center px-0 py-1 border-b">
                                        <a href="<?php echo e(route('tournees.m_index')); ?>"
                            ...
                            <?php break; ?>
                        <?php endswitch; ?>
                        <?php echo $__env->make('partials.modals._delete-tournee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php echo $__env->make('partials.modals._approve-tournee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php else: ?>
                <tr class="border-gray-300">
                    <td colspan="4" class="px-4 py-8 border-t border-gray-300 text-lg">
                        <p class="text-center"><?php echo e(__('No Tournees Found')); ?></p>
                    </td>
                </tr>
            <?php endif; ?>
        </tbody>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/mission-order-app/resources/views/tournees/index.blade.php ENDPATH**/ ?>