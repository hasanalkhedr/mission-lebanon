...
<?php endif; ?>
                    <ul class="content-between space-y-2">
                        ...
                        <!-- My Profile Item -->
                        <li>
                            <a href="<?php echo e(route('employees.show', auth()->user()->employee)); ?>"
                                class="flex items-center mx-2 px-2 py-2 text-white rounded-lg transition duration-75 group hover:bg-blue-500">
                                <span class="mx-2 font-medium"><?php echo e(__('Mon Profil')); ?></span>
                            </a>
                        </li>
                        <hr />
                        <?php if(auth()->user()->employee->role !== 'employee'): ?>
                            <!-- Calender Item -->
                            <li>
                                <a href="#"
                                    class="flex items-center mx-2 px-2 py-2 text-white rounded-lg transition duration-75 group hover:bg-blue-500">
                                    <span class="mx-2 font-medium"><?php echo e(__('Calendrier')); ?></span>
                                </a>
                            </li>
                            <hr />
                            <!-- Reports Item -->
                            <li>
                                <a href="#"
                                    class="flex items-center mx-2 px-2 py-2 text-white rounded-lg transition duration-75 group hover:bg-blue-500">
                                    <span class="mx-2 font-medium"><?php echo e(__('Rapports')); ?></span>
                                </a>
                            </li>
                            <hr />
                        <?php endif; ?>
                        ...
                        <?php if(auth()->user()->employee->role != 'employee'): ?>
                            <li>
                                <button type="button"
                                    ...
                                    <span class="flex-1 mx-2 text-left font-medium text-white"
                                        sidebar-toggle-item><?php echo e(__('Settings')); ?></span>
                                    
                                </button>
                                <ul id="dropdown-settings-" class="py-2 space-y-2 mx-2">
                                    <li>
                                        <a class="flex items-center mx-2 px-2 py-2 text-white rounded-lg transition duration-75 group hover:bg-blue-500"
                                            href="<?php echo e(route('baremes.index')); ?>">
                                            <span class="mx-2 font-medium"><?php echo e(__('Baremes')); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a class="flex items-center mx-2 px-2 py-2 text-white rounded-lg transition duration-75 group hover:bg-blue-500"
                                            ...
                                            <span class="mx-2 font-medium"><?php echo e(__('Departments')); ?></span>
                                        </a>
                                    ...
                                    <li>
                                        <a class="flex items-center mx-2 px-2 py-2 text-white rounded-lg transition duration-75 group hover:bg-blue-500"
                                            ...
                                            <span class="mx-2 font-medium"><?php echo e(__('Users')); ?></span>
                                        </a>
                                    </li>
                ...
                <nav class="w-full bg-white border-b-2 border-indigo-600 flex justify-between">
                    <div class="flex flex-col py-2">
                        <div class="px-2 text-xl font-bold text-black">
                            <?php echo e(auth()->user()->employee->first_name); ?> <?php echo e(auth()->user()->employee->last_name); ?>
...
[$__name, $__params] = $__split('megaphone', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-3822922323-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /srv/mission-order-app/resources/views/layouts/app.blade.php ENDPATH**/ ?>