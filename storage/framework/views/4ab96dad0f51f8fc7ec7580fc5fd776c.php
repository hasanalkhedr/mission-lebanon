<div id="approveModal-<?php echo e($missionOrder->id); ?>" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex justify-between items-center p-2 rounded-t border-b">
                <div class="text-base font-bold mt-3 sm:mt-0 sm:ml-4 sm:text-left blue-color">
                    <?php echo e(__('Approve MÉMOIRE DE FRAIS	')); ?>:<?php echo e($missionOrder->order_number); ?>:<?php echo e($missionOrder->purpose); ?>

                </div>
                <div>
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
                        data-modal-toggle="approveModal-<?php echo e($missionOrder->id); ?>">
            ...
            <div class="p-4 overflow-y-auto" style="max-height: 700px">
                <form method="POST"
                    action="<?php echo e(route('mission_approves.m_approve', $missionOrder->id)); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex justify-end items-center space-x-2 rounded-b ">
                        <div>
                            <button data-modal-toggle="approveModal-<?php echo e($missionOrder->id); ?>"
                                ...
                                <?php echo e(__('Review (Back to Draft)')); ?>
                        ...
                        <div>
                            <button name="action" value="approve"
                                ...
                                data-modal-toggle="approveModal-<?php echo e($missionOrder->id); ?>"><?php echo e(__('Approve (GO Next!)')); ?>
                        ...
                        <div>
                            <button name="action" value="reject"
                                ...
                                data-modal-toggle="approveModal-<?php echo e($missionOrder->id); ?>"><?php echo e(__('Reject (End process)')); ?>
...
<?php /**PATH /srv/mission-order-app/resources/views/partials/modals/_approve-memoier.blade.php ENDPATH**/ ?>