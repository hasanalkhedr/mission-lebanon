    ...
    <div id="report-content">
        <div class="report-page" style="width: 210mm; height: 277mm; margin: 0 auto; padding: 8mm; box-sizing: border-box;">
            ...
            <table class="table-auto w-full text-left">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="w-1/3">{{ $missionOrder->advance >0 ? $missionOrder->advance .' '. $missionOrder->bareme->currency: 'NON' }} </td>
                    </tr>
                    <tr>
            ...
            <table class="table-auto w-full text-left">
                ...
                <tbody>
                    <tr>
                        <td colspan="2" class="w-full px-24 pt-2 pb-2 justify-end items-end text-right">
