...
<nav class="flex justify-between items-center p-2 text-black font-bold">
    <div class="text-lg blue-color">
        <?php echo e(__('MÉMOIRE DE FRAIS')); ?>

    </div>
</nav>

<?php echo $__env->make('partials.searches._search-missions_m', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <?php $__currentLoopData = $missionOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $missionOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white hover:bg-gray-50">
                        <td class="border-b py-4 px-6 font-bold text-gray-900 whitespace-nowrap cursor-pointer"
                            onclick="window.location.href = '<?php echo e(url(route('mission_orders.m_show', $missionOrder->id))); ?>'">
                        ...
                        <td class="py-4 px-6 border-b cursor-pointer">
                            <div class="cursor-pointer">
                                <?php echo e($missionOrder->arrive_location); ?>
                        ...
                        <td class="py-4 px-6 border-b cursor-pointer">
                            <div class="cursor-pointer">
                                <?php echo e(__($missionOrder->memor_status)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/mission-order-app/resources/views/mission_orders/m_index.blade.php ENDPATH**/ ?>