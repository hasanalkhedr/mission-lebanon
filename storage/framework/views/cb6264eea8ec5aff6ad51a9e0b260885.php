        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex justify-between items-center p-4 rounded-t border-b">
                <div class="text-base font-bold mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                    <?php echo e(__('Edit Employee Password')); ?>: <?php echo e($employee->first_name); ?> <?php echo e($employee->last_name); ?>
            ...
            <!-- Modal body -->
            <div class="p-6">
                <form method="POST" action=" <?php echo e(route('employees.updatePassword', ['employee' => $employee->id])); ?> ">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex justify-end items-center p-6 space-x-2 rounded-b border-t border-gray-200">
                        ...
                        <div>
                            <button
                                ...
                                data-modal-toggle="editPasswordModal"><?php echo e(__('Edit')); ?>
...
<?php /**PATH /srv/mission-order-app/resources/views/partials/modals/_edit-password.blade.php ENDPATH**/ ?>